...
def get_arguments():
	train_params = get_params('./params/train_params_text.json')
	model_params=get_params('./params/model_params_text.json')
	dataset_params = get_params('./params/dataset_params_text.json')
